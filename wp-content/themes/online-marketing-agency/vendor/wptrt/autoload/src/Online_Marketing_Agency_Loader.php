...
class Online_Marketing_Agency_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function online_marketing_agency_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function online_marketing_agency_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function online_marketing_agency_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function online_marketing_agency_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->online_marketing_agency_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function online_marketing_agency_load( $class ) {
