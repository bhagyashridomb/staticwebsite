...
class Online_Marketing_Agency_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function online_marketing_agency_loadClassLoader($class)
    {
    ...
    public static function online_marketing_agency_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
